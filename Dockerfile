...
# docker build -t csci3100_group_proj31 .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name csci3100_group_proj31 csci3100_group_proj31
